...
const PickForPage = () => {
  return (
    <main className="mx-auto flex w-full max-w-[1100px] flex-col px-10 pb-20 pt-10">
      <Image src={image1} alt="Robot Dive Case Study 1" priority />
      <Image src={image2} alt="Robot Dive Case Study 2" />
      <Image src={image3} alt="Robot Dive Case Study 3" />
      <Image src={image4} alt="Robot Dive Case Study 4" />
    </main>
  );
};
