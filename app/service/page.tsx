...
const ServicePage = () => {
  return (
    <main className="mx-auto flex w-full max-w-[1100px] flex-col px-10 pb-20 pt-10">
      <Image src={image1} alt="Service Process 1" priority quality={100} />
      <Image src={image2} alt="Service Process 2" quality={100} />
      <Image src={image3} alt="Service Process 3" quality={100} />
    </main>
  );
};
